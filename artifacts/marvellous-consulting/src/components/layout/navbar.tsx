        ...
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <span className="hidden sm:flex flex-col leading-none">
              <span className="font-serif font-semibold text-xl text-primary">Marvellous</span>
              <span className="text-[10px] font-medium tracking-[0.2em] text-muted-foreground mt-0.5">CONSULTING</span>
            </span>
          </Link>
