  ...
  return (
    <div className="pt-24 min-h-screen">
      ...
      <section className="py-20 md:py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6 lg:px-10 xl:px-16 2xl:px-24 max-w-6xl">
      ...
      <section className="py-20 bg-card border-y border-border">
        <div className="container mx-auto px-4 md:px-6 lg:px-10 xl:px-16 2xl:px-24 max-w-5xl grid md:grid-cols-2 gap-12 items-start">
